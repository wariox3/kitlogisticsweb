...
/*!50001 CREATE TABLE `sql_manmanifiesto` (
  ...
  `Manfechpagsal` date,
  `manpago_cargue` varchar(25),
  `manpago_descar` varchar(25),
...
/*!50001 CREATE TABLE `sql_im_imprimirmanifiesto` (
  ...
  `PagoCargue` varchar(25),
  `PagoDescargue` varchar(25),
  `FhPagoSaldo` date,
